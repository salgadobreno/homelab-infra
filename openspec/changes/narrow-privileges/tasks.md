...
- [ ] 1.1 Record today's privilege state as evidence: token user and privsep flag, `cloudflared` owning user, whether `/proc/<pid>/cmdline` leaks the tunnel token, and whether root SSH is accepted
